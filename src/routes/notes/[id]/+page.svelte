<script lang="ts">
	...
	import { ChevronLeft, Edit, Trash2, AlertCircle, BookOpen, Save, X, UploadCloud } from 'lucide-svelte';
	...
	async function saveChanges() {
		...
		try {
			...
			note = { ...note, title: newTitle || 'Untitled Note', content: newContent, updatedAt: responseData.updatedAt };
			cancelEditing();
		} catch (err) {
...
<div class="mx-auto max-w-4xl py-6">
	...
	{:else}
		{#if isEditing}
			...
			>
				{#if isDraggingOver}
					<div class="pointer-events-none mb-4 flex flex-col items-center justify-center text-indigo-600">
				...
				<div class="mb-6">
					<label for="editNoteContent" class="mb-1 block text-sm font-medium text-gray-700">Content</label>
					<div class="relative">
				...
				<div class="flex items-center justify-end gap-3">
					...
					>
						<X class="mr-1 -ml-1 h-4 w-4 inline" /> Cancel
					</button>
					<button
